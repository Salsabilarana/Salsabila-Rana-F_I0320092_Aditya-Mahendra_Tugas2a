...
Tinggi = 168
BB = 54.5
Kuliah = "Universitas Sebelas Maret"
Fakuktas ="Teknik"
...
print("berat saya ", BB)
print("sekarang saya berkuliah di ", Kuliah)
print("saya berada di fakultas ", Fakuktas)
print("tepatnya di jurusan ", Jurusan)
print("itulah beberapa informasi mengenai diri saya")
